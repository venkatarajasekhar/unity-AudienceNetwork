...
//            }
        ...
        public void RegisterGameObjectForManualImpression (GameObject gameObject)
        {
        ...
        {
			NativeAdHandler handler = gameObject.GetComponent<NativeAdHandler>();
			if(handler == null) {
...
//            });
        ...
        public void ManualLogImpression ()
        {
        ...
        public void ExternalLogImpression ()
        {
